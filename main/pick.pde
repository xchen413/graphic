...
float rx=-0.06*TWO_PI, ry=-0.04*TWO_PI;     // view s manipulated when space bar (but not mouse) is pressed and mouse is moved
...
boolean viewpoint=false;  // set to show frozen viewpoint and frustum from a different 
